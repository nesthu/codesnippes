create or replace PROCEDURE UPDATE_PN_ZU_MATERAL_SEARCH AS
BEGIN

execute immediate 'truncate table HLP_PN_ZU_MATERAL_SEARCH DROP STORAGE' ;

INSERT INTO HLP_PN_ZU_MATERAL_SEARCH (
    LIEFERANTMATERIAL,
    MATERIAL_SEARCH
    )
...
--Liefrantenmaterialnummer OEM aktuell aus Klassifizierung für alle Standorte holen
        select distinct
            k.WERK ||'_'||k.OBJEKT,
...
--Liefrantenmaterialnummer  PARTNUMMER_LIEFARTNR_1 aus Klassifizierung für alle Standorte holen
        select distinct
            k.WERK ||'_'||k.OBJEKT,
...
--Liefrantenmaterialnummer PARTNUMMER_LIEFARTNR_2 aus Klassifizierung  für alle Standorte holen
        select distinct
            k.WERK ||'_'||k.OBJEKT,
...
END UPDATE_PN_ZU_MATERAL_SEARCH;
